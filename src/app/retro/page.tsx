...
export default function RetroPage() {
  ...
  return (
    <div className="relative flex-1 flex items-center justify-center px-4 py-10 sm:py-16 overflow-hidden">
      <Link
        href="/"
        className="fixed top-4 left-4 text-xs text-ink-soft/50 hover:text-ink-soft transition-colors font-body"
      >
        ‹ full version
      </Link>
      <Link
        href="/simple"
        className="fixed top-4 right-4 text-xs text-ink-soft/50 hover:text-ink-soft transition-colors font-body"
      >
        simplified version ›
      </Link>
